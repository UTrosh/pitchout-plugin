...
public class Main extends JavaPlugin {
   ...
   public InteractWithItem interactWhithItem;
   ...
   public void onEnable() {
      ...
      this.interactWhithItem = new InteractWithItem(this);
      this.playerJoin = new PlayerJoin(this);
      this.playerMove = new PlayerMove(this);
      this.playerQuit = new PlayerQuit(this);
      this.utils = new Utils(this);
      Bukkit.getServer().getMessenger().registerOutgoingPluginChannel(Bukkit.getPluginManager().getPlugin("PitchOut"), "BungeeCord");
      ...
      Bukkit.getServer().getPluginManager().registerEvents(this.damage, this);
      ...
      Bukkit.getServer().getPluginManager().registerEvents(this.interactWhithItem, this);
      ...
      if (label.equalsIgnoreCase("pitchout")) {
         ...
         if (this.language.equalsIgnoreCase("en")) {
            if (args.length == 0) {
               ...
               if (!args[0].equalsIgnoreCase("setlobby") && !args[0].equalsIgnoreCase("help") && !args[0].equalsIgnoreCase("setpos") && !args[0].equalsIgnoreCase("forcestart") && p.hasPermission("PitchOut.help")) {
                  p.sendMessage(this.utils.getPrefix() + " §fDo §a/pitchout help §ffor more informations.");
               }
